...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            //TextFile Format: id,TournamentName,EntryFee,(Entered Teams - id|id|id),(Prizes - id|id|id),(Rounds - id^id^id|id^id^id|id^id^id)
        ...
        {
            // What we are trying to get: Rounds - id^id^id|id^id^id|id^id^id
            string output = "";
        ...
        {
            // What we are trying to get: Persons - id|id|id
            string output = "";
